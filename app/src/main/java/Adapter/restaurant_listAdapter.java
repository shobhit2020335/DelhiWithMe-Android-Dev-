...
public class restaurant_listAdapter  extends RecyclerView.Adapter<restaurant_listAdapter.Viewholder>{
    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public restaurant_listAdapter(Context context, ArrayList<MainModel> modelArrayList) {
