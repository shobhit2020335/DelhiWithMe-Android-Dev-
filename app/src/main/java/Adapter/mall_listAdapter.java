...
public class mall_listAdapter  extends RecyclerView.Adapter<mall_listAdapter.Viewholder>{

    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public mall_listAdapter(Context context, ArrayList<MainModel> modelArrayList) {
