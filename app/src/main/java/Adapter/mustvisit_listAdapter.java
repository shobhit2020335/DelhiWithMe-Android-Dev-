...
import com.example.dwm.mustvisit;

import java.util.ArrayList;

public class mustvisit_listAdapter extends RecyclerView.Adapter<mustvisit_listAdapter.Viewholder>{
    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public mustvisit_listAdapter(Context context, ArrayList<MainModel> modelArrayList) {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, mustvisit.class);
