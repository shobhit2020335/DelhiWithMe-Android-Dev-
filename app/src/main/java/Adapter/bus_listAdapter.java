...
import com.example.dwm.bus;

import java.util.ArrayList;

public class bus_listAdapter extends RecyclerView.Adapter<bus_listAdapter.Viewholder> {
    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public bus_listAdapter(Context context, ArrayList<MainModel> modelArrayList) {
