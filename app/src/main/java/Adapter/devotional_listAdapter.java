...
import com.example.dwm.airport;
import com.example.dwm.devotional;

import java.util.ArrayList;

public class devotional_listAdapter extends RecyclerView.Adapter<devotional_listAdapter.Viewholder> {

    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public devotional_listAdapter(Context context, ArrayList<MainModel> modelArrayList) {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, devotional.class);
