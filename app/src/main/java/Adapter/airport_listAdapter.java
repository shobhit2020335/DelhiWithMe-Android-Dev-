...
public class airport_listAdapter  extends RecyclerView.Adapter<airport_listAdapter.Viewholder> {
    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public airport_listAdapter(Context context, ArrayList<MainModel> modelArrayList) {
