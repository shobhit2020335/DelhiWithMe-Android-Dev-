...
import com.example.dwm.railway;

import java.util.ArrayList;

public class railway_listAdapter extends RecyclerView.Adapter<railway_listAdapter.Viewholder> {
    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public railway_listAdapter(Context context, ArrayList<MainModel> modelArrayList) {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, railway.class);
