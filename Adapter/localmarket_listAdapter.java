...
public class localmarket_listAdapter extends RecyclerView.Adapter<localmarket_listAdapter.Viewholder>  {

    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public localmarket_listAdapter(Context context, ArrayList<MainModel> modelArrayList) {
