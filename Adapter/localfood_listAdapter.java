...
public class localfood_listAdapter extends RecyclerView.Adapter<localfood_listAdapter.Viewholder> {
    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public localfood_listAdapter(Context context, ArrayList<MainModel> modelArrayList) {
