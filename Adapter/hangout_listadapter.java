...
public class hangout_listadapter  extends RecyclerView.Adapter<hangout_listadapter.Viewholder>{
    private Context context;
    private ArrayList<MainModel> modelArrayList;

    public hangout_listadapter(Context context, ArrayList<MainModel> modelArrayList) {
